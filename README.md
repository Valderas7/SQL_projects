...
- **salon_appointment_scheduler**: Creación de base de datos y de un script para desarrollar un planificador de citas de salón de belleza. Se examina además de lo especificado en los dos proyectos anteriores, la capacidad de rellenar valores de la base de datos mediante la programación de un script automatizado en `Bash`. 
